...
<html lang="en">
    ...
    <body onload="showCartValue()">
        ...
        <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
            ...
            <div class="navbar-nav">
                <div class="nav-item text-nowrap">
                    <a class="nav-link px-3" href="Logout" id="logout">Sign out</a>
                </div>
            </div>
        </header>
                                    ...
                                    <c:forEach items="${requestScope.products}" var="product">
                                        <tr>
                                            ...
                                            <td><c:out value="${product.getAvailability()}"></c:out></td>
                                                <td>
                                                   <input type="number" onkeyup="if(this.value<0){this.value= this.value * -1}" onkeyup="if(this.value<0){this.value= this.value * -1}" id='Quantity_<c:out value="${product.getProductId()}"/>' value="">
                                            </td>
                                            <td>
